...
import styles from '../../css/DetailMarketing.module.css';
...
const DetailMarketing = ({ infoProduct, setInfoProduct, detailProductChange }: any) => {

    const getOgTag = metaData?.find((item: any) => item?.value === infoProduct?.og_tags_type);
    const getMetaTag = metaDataDescription?.find((item: any) => item?.value === infoProduct?.meta_desc_type);

    const [isActiveMetaTag, setIsActiveMetaTag] = useState(false);
    const [selectedMetaTag, setSelectedMetaTag] = useState(getOgTag?.name);

    const [isActiveMetaDescription, setIsActiveMetaDescription] = useState(false);
    const [selectedMetaDescription, setSelectedMetaDescription] = useState(getMetaTag?.name);
    ...
    useEffect(() => {
        setSelectedMetaTag(getOgTag?.name);
    }, [getOgTag]);

    useEffect(() => {
        setSelectedMetaDescription(getMetaTag?.name);
    }, [getMetaTag]);
                                                    ...
                                                    <div className={clsx(styles.wrapInp)}>
                                                        <div className={clsx(styles.dropDown)}>
                                                            <textarea
                                                                ...
                                                                defaultValue={infoProduct?.og_tags}
                                                    ...
                                                    <div className={clsx(styles.wrapInp)}>
                                                        <div className={clsx(styles.dropDown)}>
                                                            <textarea
                                                                ...
                                                                id=""
                                                                className={clsx(styles.textarea)}
                                                                defaultValue={infoProduct?.meta_description}
                                ...
                                <div className='col l-6'>
                                    <div className={clsx(styles.wrapInp)}>
                                        <input
                                            ...
                                            defaultValue={infoProduct?.meta_keywords}
                                ...
                                <div className='col l-6'>
                                    <div className={clsx(styles.wrapInp)}>
                                        <input
                                            ...
                                            id=""
                                            className={clsx(styles.inp)}
                                            defaultValue={infoProduct?.product_page_title}
                                    ...
                                    <div className={clsx(styles.wrapInp)}>
                                        <Stack direction="row" spacing={1} alignItems="center">
                                            ...
                                            <AntSwitch
                                                ...
                                                defaultChecked={infoProduct?.facebook_marketing_enabled}
                                    ...
                                    <div className={clsx(styles.wrapInp)}>
                                        <Stack direction="row" spacing={1} alignItems="center">
                                            ...
                                            <AntSwitch
                                                ...
                                                defaultChecked={infoProduct?.google_feed_enabled}
