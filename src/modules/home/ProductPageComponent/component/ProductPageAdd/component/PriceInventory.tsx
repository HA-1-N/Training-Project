...
const PriceInventory = ({ formValues, handleAddFormChange }: any) => {
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='col l-6'>
                                            <CheckBox
                                                ...
                                                name='tax_exempt'
                                                onChange={(e: any) => onChangeForm('tax_exempt', e.target.checked ? 1 : 0)}
                                            />
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='col l-6'>
                                            <CheckBox
                                                ...
                                                checked={formValues?.participate_sale}
                                ...
                                <div style={{ display: 'flex' }}>
                                    <DropDown style={{ width: '15%', border: '1px solid #a16eff', borderRadius: '4px' }}>
                                        <DropDownBtn onClick={handleCheckedPrice}>
                                            {/* <Input
                                                ...
                                                id='sale_price_type'
                                                value={formValues.sale_price_type}
                                                onChange={(e) => onChangeForm('sale_price_type')}
                                            /> */}
                                    ...
                                    <div>
                                        <Input
                                            ...
                                            id=""
                                            defaultValue={0}
                                            onChange={(e) => onChangeForm('sale_price', e.target.value)}
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='col l-6'>
                                    <WrapInp>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => onChangeForm('arrival_date', e.target.value)}
                                        />
                                    </WrapInp>
                                </div>
                            </div>
