              ...
              <div className="row">
                ...
                <div className="col l-6">
                  <DropDown style={{ height: 'auto' }}>
                    <DropDownBtn style={{ height: 'auto' }} onClick={handleActiveRole}>
            ...
            <div className="row">
              ...
              <div className="col l-6">
                ...
                >
                  ...
                  >
                    {isActiveMembership &&
                      fieldMembership.map((membership: any, index: number) => (
                        <DropDownItem
                          key={index}
                          onClick={(e) => {
              ...
              <div className="col l-6">
                <Input
                  ...
                  onChange={(e) => {
                    onChangeForm(
                      'forceChangePassword',
                      e.target.checked ? ForceChangePasswordEnum.Inactive : ForceChangePasswordEnum.Active,
                    );
                  }}
