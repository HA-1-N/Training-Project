...
import { Autocomplete, Checkbox, FormControl, Grid, InputLabel, makeStyles, MenuItem, Select, SelectChangeEvent, TextField } from '@mui/material';
                                                            ...
                                                            <Input
                                                                ...
                                                                onClick={() => {
                                                                    if (memberships?.includes(membershipItem.name)) {
                                                                        setMemberships(memberships?.filter((membership) => membership !== membershipItem.name));
                                                                    } else {
